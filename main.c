...
/*   Updated: 2023/03/05 14:36:40 by lebojo           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	init_level(t_level *level, char *file_path)
{
...
int	key_hook(int keycode, t_params *prm)
{
	...
	ft_putstr_fd("\n", 0);
	mlx_put_image_to_window(prm[0].mlx, prm[0].mlx_win, prm[0].img, pos.x, pos.y);
	return (0);
}
...
int	main(int argc, char **argv)
{
	...
	prm.mlx = mlx_init();
	prm.mlx_win = mlx_new_window(prm.mlx, 160, 160, NAME);
